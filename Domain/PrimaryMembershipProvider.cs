...
namespace Domain
{
    public class PrimaryMembershipProvider : MembershipProvider
    {
        ...
        public MembershipCreateStatus CreateUser(string login, string password, string email, bool isActivated, string passwordSalt, int userRoleId)
        {
            ...
            usersRepository.CreateUser(login, password, email, isActivated, passwordSalt, userRoleId);
